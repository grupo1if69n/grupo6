 ...
 * @author grupo1if69n
 */
public class TaxaServicoPorConsumoTest {
    
    private Conta conta;
    
    public TaxaServicoPorConsumoTest() {
    }
    ...
    */
    @Test
    public void testCalculoTaxaServicoPorConsumo1() {      
        System.err.println("\ntestCalculoTaxaServicoPorConsumo1:");
        
        Conta contaAtualizada = new TaxaServicoPorConsumo().atualizarValores(conta);
        double soma = 0.0;
    ...
    */
    @Test
    public void testCalculoTaxaServicoPorConsumo2() {
        System.err.println("\ntestCalculoTaxaServicoPorConsumo2:");
        
        CalculoValores calculoValores = new TaxaServicoPorConsumo();
